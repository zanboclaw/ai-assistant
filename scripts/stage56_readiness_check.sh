...
if [[ "$stage5_version_status" == "completed" && "$stage6_version_status" == "completed" && "$current_version" == "stage6-completed-shadow-validation-mainline" ]]; then
  pass "version.json 与当前 Stage 5/6 completed 状态一致"
else
