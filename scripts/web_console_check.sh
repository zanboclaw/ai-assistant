...
assert_contains "$html" "Skill Registry" "治理区 Skill Registry 区块存在"
assert_contains "$html" "Skill Detail" "治理区 Skill Detail 区块存在"
assert_contains "$html" "不显式指定 skill" "任务区 skill 选择入口存在"
...
assert_contains "$html" "Trace Replay" "任务详情页 Trace Replay 面板存在"
assert_contains "$html" "Retrieval Traces" "任务详情页 Retrieval Traces 面板存在"
